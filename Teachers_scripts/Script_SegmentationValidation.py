...
#### PyCode Folder
PyFolder = "C:\\Users\\sansg\\OneDrive\\Escriptori\\Assignment 2"
...
#### Data Folders
SessionDataFolder = "C:\\Users\\sansg\\Downloads\\VOIs\\VOIs"  # r'D:\Teaching\Master\DataSci4Health\2023_ML4PM\Week 08 - Introduction\Dataset'
os.chdir(SessionDataFolder)


NiiFile = "LIDC-IDRI-0001_R_1.nii"


#### Load Intensity Volume
NiiFile = os.path.join(SessionDataFolder, "image", NiiFile)
niiROI, _ = readNifty(NiiFile)

# Ground truth  mask of the lesion (niiROIGT)
NiiFile = os.path.join(SessionDataFolder, "nodule_mask", NiiFile)
